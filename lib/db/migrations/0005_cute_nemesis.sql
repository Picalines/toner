DROP TABLE "node_socket";--> statement-breakpoint
ALTER TABLE "node_connection" DROP CONSTRAINT "node_connection_sender_id_node_socket_id_fk";
--> statement-breakpoint
ALTER TABLE "node_connection" DROP CONSTRAINT "node_connection_receiver_id_node_socket_id_fk";
--> statement-breakpoint
