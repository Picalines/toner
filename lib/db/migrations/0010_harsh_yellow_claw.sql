...
CREATE TABLE IF NOT EXISTS "music_key" (
	...
	CONSTRAINT "music_key_composition_id_id_pk" PRIMARY KEY("composition_id","id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "music_layer" (
	"composition_id" integer NOT NULL,
	"id" varchar(36) NOT NULL,
	"name" varchar(32) NOT NULL,
	CONSTRAINT "music_layer_composition_id_id_pk" PRIMARY KEY("composition_id","id")
);
--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "music_layer" ADD CONSTRAINT "music_layer_composition_id_composition_id_fk" FOREIGN KEY ("composition_id") REFERENCES "public"."composition"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
